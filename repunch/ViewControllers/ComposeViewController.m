  ...
  replacementText: (NSString*) text
{
    if ([text isEqualToString:@"\n"]) {
        ...
        NSDictionary *dictionary = [NSDictionary dictionaryWithObjectsAndKeys:[localUser patronId], @"patron_id", [_storeObject objectId], @"store_id", [_body text], @"body", [_subject text], @"subject", [localUser first_name], @"senderName", nil];
