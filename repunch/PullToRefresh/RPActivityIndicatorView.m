...
#define PULL_TO_REFRESH_THRESHOLD 100.0
...
@interface RPActivityIndicatorView()
...
- (void)commonInit
{
	...
	_activityIndicatorView.color = [RepunchUtils darkRepunchOrangeColor];
